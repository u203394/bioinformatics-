...
### PR5: Assembly of a bacterial genome 
...
To carry out all these steps KBase, a platform that enables data uploading for further manipulation and analysis by using workflows, was used. We created different narratives for the different approaches we did. 


### PR6: Database search and taxonomic identification of a bacterial genome
